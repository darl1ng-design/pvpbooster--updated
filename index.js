        ...
        ".wrapper-grid-main-element,  .wrapper-flex-sub-element div, .wrapper-grid-sub-element-img-desc div, .promo-text-section");
        let options = {
        threshold:0.6};
        ...
        // let listLinks = document.querySelectorAll('#main-nav ul li a');
        // window.addEventListener('load', () =>{
        //     for(let i of listItems.values()){
